    ...
    <div id="about" className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 pb-16 sm:pb-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 max-w-6xl mx-auto">
          {/* Mission Card */}
          <div className="bg-primary rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
            <div className="flex items-center mb-4 sm:mb-6">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-white">{t('about.missionTitle')}</h3>
            </div>
          ...
          <div className="bg-primary rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
            <div className="flex items-center mb-4 sm:mb-6">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-white">{t('about.visionTitle')}</h3>
            </div>
            <div className="space-y-3">
              <div className="flex items-start space-x-2">
                <span className="text-white/80 text-sm mt-1">•</span>
                <p className="text-white/80 text-sm leading-relaxed">
                  {t('about.visionBullet1')}
                </p>
              </div>
              <div className="flex items-start space-x-2">
                <span className="text-white/80 text-sm mt-1">•</span>
                <p className="text-white/80 text-sm leading-relaxed">
                  {t('about.visionBullet2')}
                </p>
              </div>
            </div>
          </div>
