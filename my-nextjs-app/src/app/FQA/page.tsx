    ...
    <div className="space-y-6">
      {items.map((item, index) => (
        ...
        >
          ...
          {openItem === item.id && (
            <div className="px-8 pb-6 border-t-2 border-primary/20 bg-gradient-to-b from-primary/5 to-transparent">
              <p className="text-muted-foreground leading-relaxed pt-6 text-base">
                {item.answer}
              </p>
            </div>
          )}
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-surface/20">
      ...
      <div className="container mx-auto px-4 pt-20 pb-32">
        ...
        <div className="max-w-4xl mx-auto relative">
          ...
          <div className="absolute -top-10 -left-10 w-20 h-20 bg-gradient-to-br from-primary/10 to-accent/10 rounded-full blur-xl"></div>
          <div className="absolute -bottom-10 -right-10 w-32 h-32 bg-gradient-to-br from-highlight/10 to-primary/10 rounded-full blur-xl"></div>
